<template>
    <div>
        <h1 class="text-3xl mb-4 inline-flex">Create New User</h1>
        ...
        <div
            ...
            role="alert"
        >
            <span class="block sm:inline ms-2">User Created Successfully.</span>
        </div>
...
const updateUser = async () => {
    ...
    error.value = false;
    try {
        const res = await store.createUser(user.value);
